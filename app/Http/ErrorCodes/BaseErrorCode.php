...
class BaseErrorCode
{
    public static function FAILED_VALIDATION(): ErrorCode {
        return new ErrorCode('DEF1', 'FAILED VALIDATION', Response::HTTP_BAD_REQUEST); 
    }

    public static function INTERNAL_SERVER_ERROR(): ErrorCode {
        return new ErrorCode('DEF2', 'INTERNAL SERVER ERROR', Response::HTTP_INTERNAL_SERVER_ERROR);
    }
    ...
    public static function LIMIT_EXCEEDED(): ErrorCode {
        return new ErrorCode('DEF4', 'LIMIT EXCEEDED', Response::HTTP_NOT_ACCEPTABLE);
    }
}
