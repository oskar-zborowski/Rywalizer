...
$factory->define(App\Models\DefaultTypeName::class, static function (Faker\Generator $faker) {
    return [
        'name' => $faker->firstName,
        'description' => $faker->sentence,
        'creator_id' => $faker->randomNumber(5),
        'editor_id' => $faker->randomNumber(5),
        'created_at' => $faker->dateTime,
        'updated_at' => $faker->dateTime,
...
$factory->define(App\Models\Device::class, static function (Faker\Generator $faker) {
    return [
        'ip' => $faker->sentence,
        'uuid' => $faker->sentence,
        'os_name' => $faker->sentence,
        'os_version' => $faker->sentence,
        'browser_name' => $faker->sentence,
        'browser_version' => $faker->sentence,
        'created_at' => $faker->dateTime,
        'updated_at' => $faker->dateTime,
