...
class DefaultTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        DefaultType::insert([
            ...
            [
                'default_type_name_id' => 1,
                'name' => 'announcement-leaveAnnouncement',
                'description_simple' => '',
                'icon_id' => null,
                'color' => null,
                'is_active' => 1,
            ...
            [
                'default_type_name_id' => 1,
                'name' => 'announcement-updateComment',
                'description_simple' => '',
                'icon_id' => null,
                'color' => null,
                'is_active' => 1,
            ...
            [
                'default_type_name_id' => 1,
                'name' => 'announcement-deleteComment',
                'description_simple' => '',
                'icon_id' => null,
                'color' => null,
                'is_active' => 1,
            ...
            [
                'default_type_name_id' => 1,
                'name' => 'announcement-getAnnouncementsByAlias',
                'description_simple' => '',
                'icon_id' => null,
                'color' => null,
                'is_active' => 1,
            ...
            [
                'default_type_name_id' => 1,
                'name' => 'account-isPasswordTokenValid',
                'description_simple' => '',
                'icon_id' => null,
                'color' => null,
                'is_active' => 1,
